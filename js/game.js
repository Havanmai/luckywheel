...
/* var gameChance = 5; //total chances */
...
//wheel segments
var wheel_arr = [{src:'assets/item_wheel_10.png', highlight:'assets/item_wheel_10_h.png', color:'#475C70', regX:1, regY:223, point:0, type:1, percent:1},
				{src:'assets/item_wheel_11.png', highlight:'assets/item_wheel_11_h.png', color:'#475C70', regX:1, regY:223, point:100, type:2, percent:1},
				{src:'assets/item_wheel_05.png', highlight:'assets/item_wheel_05_h.png', color:'#F37621', regX:1, regY:223, point:5, type:1, percent:1},
				{src:'assets/item_wheel_01.png', highlight:'assets/item_wheel_01_h.png', color:'#475C70', regX:1, regY:223, point:1, type:1, percent:1},
				{src:'assets/item_wheel_02.png', highlight:'assets/item_wheel_02_h.png', color:'#7DB544', regX:1, regY:223, point:2, type:1, percent:1},
				{src:'assets/item_wheel_03.png', highlight:'assets/item_wheel_03_h.png', color:'#475C70', regX:1, regY:223, point:3, type:1, percent:1},
				{src:'assets/item_wheel_04.png', highlight:'assets/item_wheel_04_h.png', color:'#1A9DD8', regX:1, regY:223, point:4, type:1, percent:1},
				{src:'assets/item_wheel_12.png', highlight:'assets/item_wheel_12_h.png', color:'#475C70', regX:1, regY:223, point:99, type:0, percent:1},
				{src:'assets/item_wheel_06.png', highlight:'assets/item_wheel_06_h.png', color:'#3F559A', regX:1, regY:223, point:6, type:1, percent:1},
...
function startSpinWheelBig(){
	...
	/* TweenMax.to(wheelOuterContainer, totalRound, {rotation:toRotate, overwrite:true, ease: Circ.easeOut, onComplete:function(){
		...
		console.log("gameData",$.wheel[gameData.wheelNum])
		animateWheelSegment($.wheel[gameData.wheelNum], true);
		
		//slot color feature
		console.log(wheelSecond_arr)
		if(wheel_arr[gameData.wheelNum].slot != undefined && wheel_arr[gameData.wheelNum].slot.highlightColor != ''){
			...
			wheelOuterContainer.setChildIndex($.wheel['slot'+gameData.wheelNum], wheelOuterContainer.numChildren-1);
		}
...
function startSpinWheelInner(){
	...
	TweenMax.to(wheelInnerContainer, totalRound, {rotation:toRotate, overwrite:true, ease: Circ.easeOut, onComplete:function(){
		...
		if(wheelSecond_arr[gameData.wheelInnerNum].slot != undefined && wheelSecond_arr[gameData.wheelInnerNum].slot.highlightColor != ''){
			...
			wheelInnerContainer.setChildIndex($.wheelInner['slot'+gameData.wheelInnerNum], wheelInnerContainer.numChildren-1);
		}
...
/**
 * 
 * Kiem tra cac o chua du dieu kien nhan qua 
 * 
 */

/* function checkScore(){
	var checkScore=false;
	if((gameData.wheelNum == 0 && secondWheel && gameData.wheelInnerNum == 0)){
		startSpinWheelBig();
		checkScore=true
	}else{
		checkScore=false
...
function getResultOnPercent(){
	...
	/* var resultArray = [];
	for(var n=0; n<gameData.percentageArray.length; n++){
		if(gameData.percentageArray[n]!=0){
			resultArray.push(gameData.percentageArray[n]);
		}
	} */

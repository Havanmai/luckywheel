...
function buildGameCanvas(){
	...
	wheelContainer.scaleX= 1.7;
	wheelContainer.scaleY= 1.7;
	...
	buttonSpin.x = canvasW/100 * 50;
	buttonSpin.y = canvasH/100 * 85;
	...
	buttonReplay.x = canvasW/100 * 50;
	buttonReplay.y = canvasH/100 * 85;
	...
	wheelContainer.addChild( wheelOuterContainer, wheelInnerContainer, itemWheelCentre, itemWheel, lightsContainer, itemArrow, wheelPinContainer);
	gameContainer.addChild(itemPin, itemLightAnimate, buttonSpin);
	resultContainer.addChild(buttonReplay);
	
	
	canvasContainer.addChild(bg,mainContainer, wheelContainer, gameContainer, resultContainer, confirmContainer, optionsContainer, guideline);
